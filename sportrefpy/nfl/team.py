...
class NFLTeam(Team):
    ...
    def passer_all_time_stats(self):
        ...
        passing.rename(
            columns={"Yds": "Passing Yards", "Yds.1": "Sacked Yards"}, inplace=True
        )
    ...
    def rusher_all_time_stats(self):
        ...
        rushing = pd.read_html(rushing_url, header=[1], attrs={"id": "rushing"})[0]
    ...
    def returns_all_time_stats(self):
        ...
        returns = pd.read_html(returns_url, header=[1], attrs={"id": "returns"})[0]
    ...
    def defense_all_time_stats(self):
        ...
        defense = pd.read_html(defense_url, header=[1], attrs={"id": "defense"})[0]
    ...
    def coaches_all_time_data(self):
        ...
        coaches = pd.read_html(
            self.coaches_url, header=[1], attrs={"id": "coach_sums"}
        )[0]
    ...
    def roster(self, year=None):
        ...
        if year is not None:
            ...
            roster.rename(
                columns={"College/Univ": "College", "Drafted (tm/rnd/yr)": "Draft"},
                inplace=True,
            )
